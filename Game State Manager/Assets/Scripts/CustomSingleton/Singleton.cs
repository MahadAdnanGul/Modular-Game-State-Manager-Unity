...
namespace CustomSingleton
{
    ...
    /// Add using static SingletonShortcut to use this class like this Get<X>() & InitSingleton(x)
    /// </summary>
...
/// </summary>
public static partial class SingletonShortcuts
{
    /// <summary>
    /// Get singleton
    /// </summary>
